import { Vehicle, WebsiteContentSettings, Lead, Inquiry, VehicleRequest } from '../types';

export const INITIAL_CONTENT_SETTINGS: WebsiteContentSettings = {
...
export const INITIAL_VEHICLES: Vehicle[] = [
  {
    ...
    description: 'Direct North American import, clean title with clean Carfax. Equipped with panoramic moonroof, Mark Levinson 21-speaker surround audio, head-up display, adaptive variable suspension, and 21-inch gloss black alloy wheels. Inspected, customs cleared, and ready for immediate physical inspection or delivery.',
    features: [
  ...
  },
  {
    ...
    description: 'Immaculately maintained Mercedes-Benz GLE 450 4MATIC imported from Munich, Germany. Includes AMG Night Package, AIRMATIC air suspension, Burmester surround sound, panoramic sunroof, and MBUX augmented reality navigation. Full customs documentation provided.',
    features: [
  ...
  },
  {
    ...
    description: 'The ultimate Nigerian road conqueror. Brand-new condition GCC specification Land Cruiser Prado with 7 seats, dual air conditioning, kinetic dynamic suspension, cool box, and rugged 4WD low-range transfer case. Perfect for executive transport and Nigerian inter-state journeys.',
    features: [
  ...
  },
  {
    ...
    description: 'High-performance Toyota Camry XSE V6 imported directly from Houston, Texas. Dual exhaust with quad chrome tips, JBL premium 9-speaker system, sport-tuned suspension, and bird’s-eye view camera. One careful owner, zero Nigerian usage.',
    features: [
  ...
  },
  {
    ...
    description: 'The pinnacle of Nigerian family comfort and executive presence. 3-row, 7-passenger SUV equipped with digital rearview mirror, ventilated front seats, panoramic moonroof, hands-free power liftgate, and dynamic torque-vectoring AWD.',
    features: [
      ...
      'Dynamic Torque-Vectoring AWD with Mud/Sand & Rock/Dirt Modes',
  ...
  },
  {
    ...
    description: 'The definitive executive sports sedan with the coveted Civic Type-R derived 2.0L VTEC Turbo powerplant paired with a smooth 10-speed automatic transmission. Packed with adaptive damper suspension, ventilated seats, and heads-up display.',
    features: [
...
export const INITIAL_LEADS: Lead[] = [
  ...
  },
  {
    ...
    source: 'WhatsApp',
    status: 'Qualified',
    notes: 'Needs bulletproofing consultation or heavy duty suspension for Port Harcourt trips. Ready to wire 70% commitment fee upon proforma invoice.',
  ...
  },
  {
    ...
    source: 'Website Inquiry',
    status: 'Contacted',
    notes: 'Inquired about customs clearance documents and VIN check report. Verified Carfax emailed to customer.',
    assignedTo: 'Mosobalaje Senior Specialist',
...
export const INITIAL_INQUIRIES: Inquiry[] = [
  ...
  },
  {
    ...
    message: 'Can you source a 2024 Toyota Land Cruiser 300 VXR directly from Dubai or Japan and clear at Tin Can Port for nationwide delivery? Kindly share procurement timeline.',
...
export const INITIAL_VEHICLE_REQUESTS: VehicleRequest[] = [
  {
    ...
    fuelType: 'Petrol',
    bodyType: 'SUV',
    requirements: 'Must be Magno Matte Black or Obsidian Black exterior with Bengal Red interior. Clean auction score 4.5+ or dealership certified. Nationwide doorstep flatbed delivery.',
