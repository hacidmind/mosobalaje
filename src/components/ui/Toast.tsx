    ...
    <ToastContext.Provider value={{ toast }}>
      ...
      <div className="fixed bottom-5 right-5 z-50 flex flex-col gap-2.5 max-w-md w-full pointer-events-none px-4">
        {toasts.map((t) => (
          <div
            key={t.id}
            className="pointer-events-auto bg-stone-900/95 backdrop-blur-md text-white p-4 rounded-xl shadow-2xl border border-stone-800 flex items-start gap-3 transform transition-all duration-300"
          >
